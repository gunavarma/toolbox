...
export const Footer = () => {
  return (
    <footer className="w-full border-t border-zinc-900 bg-zinc-950/80 mt-auto py-12 px-6 sm:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8">
        ...
        {/* Categories Col 1 */}
        <div>
          <h4 className="text-xs font-semibold text-zinc-200 uppercase tracking-widest mb-4">Categories</h4>
        ...
        {/* Categories Col 2 */}
        <div>
          <h4 className="text-xs font-semibold text-zinc-200 uppercase tracking-widest mb-4">More Tools</h4>
          <ul className="space-y-2.5 text-sm text-zinc-400">
        ...
        {/* Company & Legal */}
        <div>
          <h4 className="text-xs font-semibold text-zinc-200 uppercase tracking-widest mb-4">Platform</h4>
          <ul className="space-y-2.5 text-sm text-zinc-400">
            <li>
